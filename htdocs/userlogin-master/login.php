...
<head>
	...
	<title>ToolsWithBenefits Login</title>
	...
	<div class="d-flex justify-content-center h-100">
		<div class="user_card">
			...
			<div class="d-flex justify-content-center mt-3 login_container">
				<button type="button" name="button" id="login" class="btn login_btn" onClick="">Login</button> 
			</div>
			</form>
			<div class="mt-4">
				<div class="d-flex justify-content-center links">
					Don't have an account? <a href="useraccounts-master/registration.php" class="ml-2">Sign Up</a>
				</div>
				<div class="d-flex justify-content-center">
		...
		$('#login').click(function(e){
			...
			$.ajax({
				...
				success: function(data){
                    fun();
					alert(data);
					if($.trim(data) === "Login Successfull!")
                    {
                        $_SESSION['USER_NAME'] = $username;
						setTimeout('window.location.href = "./ToolsWithBenefits/ind.php"',1000);
					}
				},
				error: function(data){
