...
<body>
  ...
  <form id="my_frm" action="https://v2.convertapi.com/convert/pdf/to/encrypt?Secret=YOUR_API_KEY&download=attachment" method="post" enctype="multipart/form-data" onsubmit="return submitForm();">
    ...
    <label for="file-upload" class="drop-container">
      ...
      <div>
        ...
        <input type="password" id="owner-password" name="OwnerPassword">
      </div>
  ...
  <script>
    ...
    submitBtn.addEventListener('click', () => {
      ...
      // Set the user and owner password values in the form data
      const form = document.getElementById('my_frm');
      const formData = new FormData(form);
      formData.set('UserPassword', userPasswordInput.value);
      formData.set('OwnerPassword', ownerPasswordInput.value);
