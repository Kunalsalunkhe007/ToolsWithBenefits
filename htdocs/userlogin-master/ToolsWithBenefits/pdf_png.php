...
<body>
  ...
  <form id="my_frm" action="https://v2.convertapi.com/convert/pdf/to/png?Secret=YOUR_API_KEY&download=attachment" method="post" enctype="multipart/form-data" onsubmit="return submitForm();">
