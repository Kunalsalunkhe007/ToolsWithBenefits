...
<body>
  ...
  <form id="my_frm" action="https://v2.convertapi.com/convert/docx/to/pdf?Secret=YOUR_API_KEY&download=attachment" method="post" enctype="multipart/form-data" onsubmit="return submitForm();">

  <label for="file-upload" class="drop-container">
    <span class="drop-title">Drop files here</span>
    or
    <input type="file" id="file-upload" name="File" accept=".doc,.docx" required>
